...
# add variable conditionBYstage
cleanSce$conditionBYstage <- paste(cleanSce$condition, cleanSce$stage, sep="_")
...
######### and plot
########png(paste0(saveImg, "02_05_tSNE_denoised_kmeans.png"), type="cairo", units="in", width=8, height=6, pointsize=12, res=300)
########grid.arrange(
