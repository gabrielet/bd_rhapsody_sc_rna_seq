#' ---
#' title: "K-means clustering for EAE size-factored data with selected set of highly variable genes"
#' author: "gabrielet"
...
# load data
kmeansSce <- readRDS(paste0(saveIn, paste0("reduced_HVGs_data_", expN, ".Rds")))
...
png(paste0(saveImg, "03_01_tSNE_kmeans_", ks, ".png"), type="cairo", units="in", width=8, height=6, pointsize=12, res=300)
grid.arrange(
...
png(paste0(saveImg, "03_02_dendrogram.png"), type="cairo", units="in", width=8, height=6, pointsize=12, res=300)
	plot(cent.tree)
dev.off()

# finally, store the normalised objects
saveRDS(object=kmeansSce, file=paste0(saveIn, "kmeans_HVGs_clustered_data_", expN, ".Rds"))
